...
//======================================ACTION CALLS=========================================//	
	...
	function _stake(uint256 _amount) internal {
		...
		require(/*frozenOf(msg.sender)*/ info.users[msg.sender].frozen + _amount >= MINIMUM_STAKE, "Your amount is lower than the minimum amount allowed to stake");
	...
	function _unstake(uint256 _amount) internal {
		...
		require(/*frozenOf(msg.sender)*/ info.users[msg.sender].frozen >= _amount, "You currently do not have up to that amount staked");
