...
{ 
    ...
    uint public _totalsupply = 1000000000 * (uint256(10) ** 8); // 1 billion SAT
    ...
    {
        owner = msg.sender;
        balances[owner] = 350000000 * (uint256(10) ** 8);
        balances[address(this)] = 650000000 * (uint256(10) ** 8);
    ...
    function () public payable atStage(Stages.ICO)
    {
        ...
        uint256 ethCent = 37*10**13; // price.USD(0); //one USD cent in wei // replaced with constant to deal with overapproximation
        uint256 tokPrice = (ethCent * 14); //1Sat = 14 USD cent
        
        tokPrice = (tokPrice / (10 ** 8)); //limit to 10 places
        uint256 no_of_tokens = ((msg.value) / tokPrice);
        ...
        if (now < ico_first)
        {
            ...
            {
                bonus_token = (((no_of_tokens * 50)) / 100); // 50% bonus
            }
            else if (no_of_tokens >   19999 * (uint256(10)**8) &&
                     no_of_tokens <= 149999 * (uint256(10)**8))
            {
                bonus_token = (((no_of_tokens * 55)) / 100); // 55% bonus
            }
            else if (no_of_tokens > 149999 * (uint256(10)**8))
            {
                bonus_token = (((no_of_tokens * 60)) / 100); // 60% bonus
            }
            else
            {
                bonus_token = (((no_of_tokens * 45)) / 100); // 45% bonus
            }
        }
        else if (now >= ico_first && now < ico_second)
        {
            if (no_of_tokens >=  2000 * (uint256(10)**8) &&
                no_of_tokens <= 19999 * (uint256(10)**8))
            {
                bonus_token = (((no_of_tokens * 40)) / 100); // 40% bonus
            }
            else if (no_of_tokens >   19999 * (uint256(10)**8) &&
                     no_of_tokens <= 149999 * (uint256(10)**8))
            {
            ...
            {
                bonus_token = (((no_of_tokens * 35)) / 100); // 35% bonus
            }
        }
        else if (now >= ico_second && now < ico_third)
        {
            if (no_of_tokens >=  2000 * (uint256(10)**8) &&
                no_of_tokens <= 19999 * (uint256(10)**8))
            {
                bonus_token = (((no_of_tokens * 30)) / 100); // 30% bonus
            }
            else if (no_of_tokens >   19999 * (uint256(10)**8) &&
                     no_of_tokens <= 149999 * (uint256(10)**8))
            {
            ...
            {
                bonus_token = (((no_of_tokens * 25)) / 100); // 25% bonus
            }
        }
        else if (now >= ico_third && now < ico_fourth)
        {
            if (no_of_tokens >=  2000 * (uint256(10)**8) &&
                no_of_tokens <= 19999 * (uint256(10)**8))
            {
                bonus_token = (((no_of_tokens * 20)) / 100); // 20% bonus
            }
            else if (no_of_tokens >   19999 * (uint256(10)**8) &&
                     no_of_tokens <= 149999 * (uint256(10)**8))
            {
            ...
            {
                bonus_token = (((no_of_tokens * 15)) / 100); // 15% bonus
            }
        }
    ...
    function burn(uint256 _amount) external onlyOwner
    {
        ...
        balances[address(0x0)] = ((balances[address(0x0)]) + _amount);
