...
contract StandardToken is ERC20, SafeMath {
  ...
  returns (bool success) {
      ...
      allowed[msg.sender][_spender] = oldValue + _addedValue;
  ...
  returns (bool success) {
      ...
      if (_subtractedValue > oldVal) {
          ...
          allowed[msg.sender][_spender] = oldVal - _subtractedValue;
      }
      Approval(msg.sender, _spender, allowed[msg.sender][_spender]);
      return true;
  }
...
contract UpgradeAgent {
    ...
    function originalSupply() public returns (uint);  //uint public originalSupply;
