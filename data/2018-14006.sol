...
contract ERC223 is ERC20 {
	...
	function transfer4(address _to, uint256 _value, bytes _data, string _customFallback) public returns (bool success);
...
contract NGToken is ERC223 {
	...
	uint256 constant private INITIAL_SUPPLY	= 20000000000 * (10 ** 18 /* uint256(DECIMALS) */);
