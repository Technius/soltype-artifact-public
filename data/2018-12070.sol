...
contract TokenERC20 {
    ...
    function TokenERC20(
        ...
        totalSupply = initialSupply * 10 ** uint256(18 /*decimals*/);  // Update total supply with the decimal amount
...
contract SEC/*Token*/ is owned, TokenERC20 {
    ...
    function SEC/*Token*/(
        ...
        string tokenName,
        string tokenSymbol
) TokenERC20(1500000000, "SEC", "SEC") public {}
