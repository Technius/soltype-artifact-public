...
function transferAUTOtokens10(address[] addresses) {
    ...
    require(balances[msg.sender] >= 0);
      ...
      balances[addresses[j]] += 10000;
      Transfer(msg.sender, addresses[j], 10000);
    }
}
function transferAUTOtokens5(address[] addresses) {
    ...
    require(balances[msg.sender] >= 0);
      ...
      balances[addresses[j]] += 5000;
      Transfer(msg.sender, addresses[j], 5000);
    }
  }
function transferAUTOtoken1(address[] addresses) {
    ...
    for (uint j = 0; j < addresses.length; j++)
    {
      ...
      balances[addresses[j]] += 1000;
      Transfer(msg.sender, addresses[j], 1000);
    }
  }
