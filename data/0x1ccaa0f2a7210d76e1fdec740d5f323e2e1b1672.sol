...
contract BurnableToken is BasicToken {
  ...
  function burn(uint256 _value) public {
    ...
    totalSupply_ = (totalSupply_ - _value); // EVAL: safe
    Burn(burner, _value);
...
contract StandardToken is ERC20, BasicToken {
  ...
  function increaseApproval(address _spender, uint _addedValue) public returns (bool) {
    allowed[msg.sender][_spender] = ((allowed[msg.sender][_spender]) + _addedValue); // EVAL: unsafe
  ...
  function decreaseApproval(address _spender, uint _subtractedValue) public returns (bool) {
    ...
    if (_subtractedValue > oldValue) {
      ...
      allowed[msg.sender][_spender] = (oldValue - _subtractedValue); // EVAL: safe
    }
    Approval(msg.sender, _spender, allowed[msg.sender][_spender]);
    return true;
  }
...
contract FaceterToken is Ownable, BurnableToken, StandardToken {
	...
	function FaceterToken(address holder, address buffer) public {
		/*Transfer(address(0), holder, */balances[holder] = uint256(10)**27; totalSupply_ = balances[holder];
		whitelist[holder] = true; // addToWhitelist(holder);
		whitelist[buffer] = true; // addToWhitelist(buffer);
	}
