...
contract Controlled is Owned{
    ...
    function Controlled() public {
        exclude[msg.sender]=true;  // setExclude(msg.sender);
    }
...
contract SMT is StandardToken {
    ...
    function approveAndCall(address _spender, uint256 _value, bytes _extraData) public returns (bool success) {
        ...
        /*if*/require(/*!*/_spender.call(bytes4(bytes32(keccak256("receiveApproval(address,uint256,address,bytes)"))), msg.sender, _value, this, _extraData));// { revert(); }
        return true;
    }
    ...
    function approveAndCallcode(address _spender, uint256 _value, bytes _extraData) public returns (bool success) {
        ...
        /*if*/require(/*!*/_spender.call(_extraData));// { revert(); }
        return true;
    }
    ...
    function allocateTokens(address[] _owners, uint256[] _values) public onlyOwner {
        ...
        for(uint256 i = 0; i < _owners.length ; i++){
            ...
            require(totalSupply + value > totalSupply);require(balances[to] + value > balances[to]); //if(totalSupply + value <= totalSupply || balances[to] + value <= balances[to]) revert();
            totalSupply += value;
            balances[to] += value;
        }
    }
